...
const useProjectStore = create((set, get) => ({
  ...
  loadProjects: async () => {
    ...
    if (!api2) return;
    try {
      const projects = await api2.project.list();
      set({ projects });
    } catch (err) {
  ...
  openProject: async (projectDir) => {
    ...
    set({ loading: true, error: null });
    try {
      const project = await api2.project.open(projectDir);
      set({ currentProject: project, loading: false });
    } catch (err) {
      set({ error: err.message, loading: false });
    }
  ...
  refreshProject: async () => {
    ...
    if (!api2) return;
    try {
      const project = await api2.project.get();
  ...
  generateScript: async (userInput, style) => {
    ...
    try {
      ...
      await api2.project.update({
        outline: result.outline,
        characters: result.outline.characters.map((c, i) => ({
          id: c.id || `char_${i + 1}`,
          name: c.name,
  ...
  startPipeline: async () => {
    ...
    set({ loading: true, error: null });
    const unsubPhase = api2.pipeline.onPhase((phase) => {
      set((s) => ({ pipelineProgress: { ...s.pipelineProgress, phase } }));
    });
    const unsubProgress = api2.pipeline.onProgress(({ done, total }) => {
      set({ pipelineProgress: { phase: "rendering", done, total } });
    });
    const unsubDone = api2.pipeline.onDone(() => {
      set({ loading: false });
      get().refreshProject();
    });
    const unsubError = api2.pipeline.onError((err) => {
      set({ error: err, loading: false });
    });
    try {
      await api2.pipeline.start();
    } catch (err) {
      set({ error: err.message, loading: false });
      unsubPhase();
      unsubProgress();
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center p-8 overflow-auto", children: [
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-2xl mb-4 p-3 bg-red-900/30 border border-red-700 rounded-lg text-red-300 text-sm", children: error }),
    showNew && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md bg-dark-800 border border-dark-600 rounded-xl p-6 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold mb-4", children: "新建项目" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm text-dark-400 mb-1", children: "项目标题 / 创意" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              value: title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm text-dark-400 mb-1", children: "视觉风格" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "anime", children: "动漫 / 日系" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "realistic", children: "写实" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "3d", children: "3D 渲染" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "watercolor", children: "水彩" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "comic", children: "漫画" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cinematic", children: "电影感" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm text-dark-400 mb-1", children: "目标时长 (秒)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
...
function StoryboardEditor() {
  ...
  const [selectedChapter, setSelectedChapter] = reactExports.useState(0);
    ...
    !hasScript && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: loading ? "生成中..." : "生成剧本"
        }
      )
    ] }),
    hasScript && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-56 bg-dark-800 border-r border-dark-700 overflow-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 text-sm font-semibold text-dark-400 border-b border-dark-700", children: [
          "章节 (",
          chapters.length,
          ")"
        ] }),
        chapters.map((ch, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: () => setSelectedChapter(i),
            className: `w-full text-left px-3 py-2.5 text-sm transition-colors border-l-2 ${selectedChapter === i ? "bg-dark-700 border-primary-500 text-white" : "border-transparent text-dark-400 hover:text-dark-200 hover:bg-dark-700/50"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: ch.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-dark-500 mt-0.5", children: [
                ch.shots.length,
                " 分镜 · ",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-dark-800 border border-dark-700 rounded-lg overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-dark-500 text-sm w-6", children: [
            "#",
            index + 1
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs px-2 py-0.5 rounded ${statusColor[shot.status]}`, children: shot.status }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2 py-0.5 rounded bg-dark-700 text-dark-300", children: typeLabel[shot.shotType] || shot.shotType }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-dark-300 flex-1 truncate", children: shot.sceneDescription }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-dark-500", children: [
            shot.durationSec,
            "s"
          ] })
        ]
    ...
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 space-y-3 border-t border-dark-700", children: [
      ...
      shot.dialogue.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        shot.dialogue.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 text-sm", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark-200", children: d.text }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-dark-500 ml-2", children: [
            "(",
            d.tone,
            ")"
          ] })
      ...
      shot.camera && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-dark-200 mt-1", children: [
...
function CharacterCard({ character }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-dark-800 border border-dark-700 rounded-xl p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-1 text-xs text-dark-400", children: [
      ...
      d.distinctiveFeatures && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "特征: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-dark-800 border border-dark-700 rounded-xl p-6 mb-6", children: [
      ...
      total > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm text-dark-400 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "分镜进度" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            done,
            "/",
            total,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 bg-dark-700 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        failed > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-400 mt-2", children: [
          failed,
          " 个分镜失败"
        ] })
      ] })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 p-3 bg-red-900/30 border border-red-700 rounded-lg text-red-300 text-sm", children: error }),
    currentProject.script && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-dark-400 mb-3", children: "分镜列表" }),
...
function WorkspacePage() {
  ...
  if (!currentProject) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-dark-400", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "请先创建或打开一个项目" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-dark-700 bg-dark-800", children: TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setActiveTab(tab.id),
        className: `px-5 py-3 text-sm font-medium transition-colors border-b-2 ${activeTab === tab.id ? "border-primary-500 text-primary-400" : "border-transparent text-dark-400 hover:text-dark-200"}`,
        children: tab.label
      },
      tab.id
    )) }),
...
function PreviewPanel() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-dark-400", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-2", children: "视频预览" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "渲染完成后可在此预览和检查分镜" })
  ] }) });
}
...
function App() {
  ...
  const { currentProject } = useProjectStore();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen w-screen flex flex-col bg-dark-900 text-dark-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold text-primary-400", children: "Video AI Studio" }),
            currentProject && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-dark-400", children: [
              "— ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 overflow-hidden", children: [
      currentView === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}),
      currentView === "workspace" && /* @__PURE__ */ jsxRuntimeExports.jsx(WorkspacePage, {}),
      currentView === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPage, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "h-7 flex items-center px-4 bg-dark-800 border-t border-dark-700 text-xs text-dark-500", children: currentProject ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      "阶段: ",
      currentProject.pipelineState.phase,
      " · 分镜: ",
      currentProject.pipelineState.completedShots,
      "/",
      currentProject.pipelineState.totalShots
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "就绪" }) })
  ] });
}
function NavButton({ label, active, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      onClick,
      className: `px-3 py-1.5 rounded text-sm transition-colors ${active ? "bg-primary-600 text-white" : "text-dark-300 hover:text-white hover:bg-dark-700"}`,
      children: label
    }
  );
}
